...
namespace AMM {
    ...
    private:
        ...
        AMM::UUID m_id;
        AMM::UUID m_event_id;
        AMM::AssessmentValue m_value{AMM::OMISSION_ERROR};
    ...
    public:
         ...
         */
        eProsima_user_DllExport const eprosima::fastcdr::fixed_string<4096>& data() const;

        /*!
         * @brief This function returns a reference to member data
         * @return Reference to member data
         */
        eProsima_user_DllExport eprosima::fastcdr::fixed_string<4096>& data();
    ...
    private:
        ...
        AMM::EventAgentType m_agent_type{AMM::LEARNER};
        AMM::UUID m_agent_id;
        std::string m_type;
        eprosima::fastcdr::fixed_string<4096> m_data;
    ...
    private:
        ...
        AMM::FAR_Status m_status{AMM::REQUESTING};
        AMM::FMA_Location m_location;
        AMM::EventAgentType m_agent_type{AMM::LEARNER};
        AMM::UUID m_agent_id;
    ...
    private:
        ...
        AMM::LogLevel m_level{AMM::L_FATAL};
    ...
    public:
         ...
         */
        eProsima_user_DllExport const eprosima::fastcdr::fixed_string<12000>& capabilities_configuration() const;
         ...
         */
        eProsima_user_DllExport eprosima::fastcdr::fixed_string<12000>& capabilities_configuration();
    ...
    private:
        ...
        AMM::UUID m_educational_encounter;
        uint64_t m_timestamp{0};
        eprosima::fastcdr::fixed_string<12000> m_capabilities_configuration;
    ...
    public:
         ...
         */
        eProsima_user_DllExport const eprosima::fastcdr::fixed_string<12000>& capabilities_schema() const;

        /*!
         * @brief This function returns a reference to member capabilities_schema
         * @return Reference to member capabilities_schema
         */
        eProsima_user_DllExport eprosima::fastcdr::fixed_string<12000>& capabilities_schema();
    ...
    private:
        ...
        std::array<uint8_t, 4> m_ip_address{0};
        eprosima::fastcdr::fixed_string<12000> m_capabilities_schema;
    ...
    private:
        ...
        uint64_t m_timestamp{0};
        AMM::ControlType m_type{AMM::RUN};
        AMM::UUID m_educational_encounter;
    ...
    private:
        ...
        uint64_t m_timestamp{0};
        AMM::StatusValue m_value{AMM::OPERATIONAL};
        std::string m_message;
