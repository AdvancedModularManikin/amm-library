...
inline int AmmDataType <T, L, A, U> :: CreatePublisher () {
   ...
   try {
      ...
      m_publisher->updateAttributes(pa);
...
inline int AmmDataType <T, L, A, U> :: CreateSubscriber (
   ...
   try {
      ...
      m_subscriber->updateAttributes(sa);
...
template <class T, class L, class A, class U>
inline int AmmDataType <T, L, A, U> :: CreateSubscriber (
   std::string& errmsg, ListenerInterface* li, U* parentClass, void (U::*onEvent) (A&, eprosima::fastrtps::SampleInfo_t*)
) {
